...
func InstallUI(client *http.Client, ui config.Ui, targetDir, userAgent, prefix string) error {
	...
	if err := utils.DownloadFile(context.Background(), client, ui.DownloadURL(), tmpPath, userAgent, "  web ui     "); err != nil {
